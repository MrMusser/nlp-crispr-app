...
def preprocess_sentence(sentence):
    ...
    words_lemmatized = [lem.lemmatize(word, convert_part_of_speech_tag(pos)) for word, pos in pos_tagged]

    #Remove stopwords and rejoin the sentence
    words_unstopped = remove_stopwords(words_lemmatized)
    joined_sentence = ' '.join(words_unstopped)

    return joined_sentence
classifier = pickle.load(open('text_classifier.sav', 'rb'))
vectorizer = pickle.load(open('vectorizer.sav', 'rb'))
def predict_sentence(sentence):
    preprocessed_sentence = preprocess_sentence(sentence)
    vectorized_sentence = vectorizer.transform([preprocessed_sentence])
    predictions = classifier.predict_proba(vectorized_sentence)
    return predictions
...
@cross_origin(origins=['https://mrmusser.github.io'])
def calculate_probabilities():
    ...
    predictions = classifier.predict_proba(transformed_input)
